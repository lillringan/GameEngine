...
public class Game {
	...
	PointLight pLight1 = new PointLight(new BaseLight(new Vector3f(1,0.5f,0),0.8f), new Attenuation(0.01f, 0.00001f, 0.001f), new Vector3f(-2, 0, 3f), 10);
	PointLight pLight2 = new PointLight(new BaseLight(new Vector3f(0,0.5f,1),0.8f), new Attenuation(0.01f, 0.00001f, 0.001f), new Vector3f(2, 0, 7f), 10);
	...
	public void update() {
		...
		pLight2.setPosition(new Vector3f(7 * (float)(Math.cos(temp) + 1.0/2.0) + 10,0,8.0f));
