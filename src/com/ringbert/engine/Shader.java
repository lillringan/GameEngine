...
public class Shader {
	...
	public Shader(){
		...
		if(program == 0){
			System.err.println("Shader creation failed: could not find a valid memory location in constructor");
			System.exit(1);
		}
	}
	...
	private void addProgram(String text, int type){
		...
		if(shader == 0){
			System.err.println("Shader creation failed: could not find a valid memory location when adding shader");
			System.exit(1);
		}
